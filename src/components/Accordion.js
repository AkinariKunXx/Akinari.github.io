  ...
  return (
    <>
      <Accordion open={open === 1} animate={CUSTOM_ANIMATION}>
        <AccordionHeader onClick={() => handleOpen(1)} className="white fw-600 fs-m2 mb-5">Качественный сервис</AccordionHeader>
      ...
      <Accordion open={open === 2} animate={CUSTOM_ANIMATION}>
        <AccordionHeader onClick={() => handleOpen(2)} className="white fw-600 fs-m2 mb-5">Клиентоориентированный подход</AccordionHeader>
        <AccordionBody className="indigo-lightest opacity-40 fw-100 fs-m1 mb-1">
      ...
      <Accordion open={open === 3} animate={CUSTOM_ANIMATION}>
        <AccordionHeader onClick={() => handleOpen(3)} className="white fw-600 fs-m2 mb-5">Первоклассные компоненты</AccordionHeader>
        <AccordionBody className="indigo-lightest opacity-40 fw-100 fs-m1 mb-1">
