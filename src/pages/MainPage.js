        ...
        <>
            ...
            <section id="home" className="min-h-100vh flex justify-start items-center">
                ...
                <div>
                    ...
                    />
                    <button className="button-lg bg-indigo-lightest-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0">
                        Get Started
                    </button>
                    </div>
            ...
            <section id="features" className="p-10 md-p-l5">
                ...
                <div className="w-100pc md-w-40pc">
                    ...
                    <h4 className="white fw-600 fs-m3 mb-5">Re</h4>
                ...
                <div className="w-100pc md-w-40pc">
                    <div className="br-8 p-5 m-5">
                    <div className="flex justify-center items-center bg-indigo-lightest-10 white w-l5 h-l5 br-round mb-5">
                        <i data-feather="cpu" className="w-l5" />
                    </div>
                ...
                <div className="w-100pc md-w-40pc">
                    <div className="br-8 p-5 m-5">
                    <div className="flex justify-center items-center bg-indigo-lightest-10 white w-l5 h-l5 br-round mb-5">
                        <i data-feather="database" className="w-l5" />
                    </div>
            ...
            <section className="relative bg-indigo-lightest-10">
                ...
                <div className="p-10 md-p-l10 flex justify-center items-center flex-column text-center">
                    ...
                    <a
                    href="#"
                    className="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5"
                    >
                    BUY NOW
                    </a>
                </div>
                ...
                <li>
                    <button className="prev ml-10 br-round border-indigo-lightest indigo-lightest  bg-transparent flex justify-center items-center p-2 focus-indigo-lighter outline-none">
                    <i data-feather="chevron-left" />
                    </button>
                </li>
                <li>
                    <button className="next mr-10 br-round border-indigo-lightest indigo-lightest  bg-transparent flex justify-center items-center p-2  focus-indigo-lighter outline-none">
            ...
            <section className="p-10 md-py-10">
                ...
                <h2 className="white fs-l2 md-fs-xl1 fw-900 lh-2">
                    ...
                    <span className="border-b bc-indigo bw-4"> consectetur</span> adipiscing
            ...
            <section id="pricing">
                ...
                <div className="w-100pc md-w-25pc">
                    ...
                    <div className="p-3">
                        ...
                        $<span className="fs-l5 lh-1">0</span>/mo
                        </div>
                    </div>
                    <div className="p-3 indigo-lightest fw-400 fs-s1 lh-5">
                        <div>
                        <i className="h-3 indigo" strokeWidth={4} data-feather="check" />
                        <span className="opacity-50">1 user</span>
                        </div>
                        <div>
                        <i className="h-3 indigo" strokeWidth={4} data-feather="check" />
                        <span className="opacity-50">100 visitors/month</span>
                        </div>
                        <div>
                        <i className="h-3 indigo" strokeWidth={4} data-feather="check" />
                        <span className="opacity-50">1 website</span>
                        </div>
                        <div>
                        <i className="h-3 indigo" strokeWidth={4} data-feather="check" />
                        <span className="opacity-50">24x7 support</span>
                        </div>
                        <div>
                        <i className="h-3" strokeWidth={4} data-feather="x" />
                        <span className="opacity-50">third party integration</span>
                        </div>
                    </div>
                    <div className="p-3">
                ...
                <div className="w-100pc md-w-25pc">
                    ...
                    <div className="p-3">
                        ...
                        $<span className="fs-l5 lh-1">99</span>/mo
                        </div>
                    </div>
                    <div className="p-3 black fw-400 fs-s1 lh-5">
                        <div>
                        <i className="h-3 indigo" strokeWidth={4} data-feather="check" />
                        <span className="opacity-50"> 5 user</span>
                        </div>
                        <div>
                        <i className="h-3 indigo" strokeWidth={4} data-feather="check" />
                        <span className="opacity-50">10,000 visitors/month</span>
                        </div>
                        <div>
                        <i className="h-3 indigo" strokeWidth={4} data-feather="check" />
                        <span className="opacity-50">3 website</span>
                        </div>
                        <div>
                        <i className="h-3 indigo" strokeWidth={4} data-feather="check" />
                        <span className="opacity-50">24x7 support</span>
            ...
            <section className="p-10 md-p-l10">
                ...
                <div
                className="relative w-100pc h-75vh bg-cover bg-b"
                style={{
                    backgroundImage:
                    "url(assets/images/nicholas-kwok-VBWWscZtszY-unsplash.jpg)"
                }}
                >
                <a
                    href="#"
            ...
            <footer className="p-5 md-p-l5 bg-indigo-lightest-10">
                ...
                <div className="md-w-25pc mb-10">
                    ...
                    <p>
                        © 2020-2024 PULSETECH. Все права защищены. "PULSETECH" - является
                        товарным знаком ООО "ИНОВАЦИИ", зарегистрированным в России и других
                        странах.
                    </p>
                    <br />
                    </div>
                ...
                <div className="w-100pc md-w-25pc">
                    ...
                    <input
                        type="text"
                        className="input flex-grow-1 bw-0 fw-200 bg-indigo-lightest-10 white ph-indigo-lightest focus-white opacity-80 fs-s3 py-5 br-r-0"
                        placeholder="Email"
                    />
                    <button className="button bg-indigo indigo-lightest fw-300 fs-s3 br-l-0">
                        Start
                    </button>
                    </div>
                    ...
                    <a
                        href="#"
                        className="relative p-5 bg-indigo br-round white hover-scale-up-1 ease-400"
                    >
